      ...
      <View style={styles.container}>
        ...
        <View style={styles.compareRow}>
          ...
          <View style={[styles.card, styles.originalCard]}>
            ...
            <Text style={styles.price}>{formatPrice(original.price, original.currency)}</Text>
          ...
          <View style={[styles.card, styles.substituteCard]}>
            ...
            <Text style={styles.price}>{formatPrice(substitute.price, substitute.currency)}</Text>
